...
%     \resizebox{\columnwidth}{!}{
%         \input{Data/results/JNI/Benchmark_common_table.tex}
%     }
% \end{table}
%
% \begin{table}[H]
...
\begin{table}
    \centering
    \label{fig:java:common:float}
    \caption{Java Common table \texttt{float}}
    \input{Data/results/FLOAT/Java_common_table_FLOAT.tex}
\end{table}

\begin{table}
    \centering
    \label{fig:cpp:common:float}
    \caption{C++ Common table \texttt{float}}
