...
In this thesis, different aspects that affects execution time for an FFT implementation are tested. To get an overview of how much of an impact they have, the following subjects were investigated:
