...
In this thesis, different aspects that can affect execution time for an \gls{fft} implementation on Android were tested. A link to a repository where the benchmark program, data and algorithms can be found in Appendix~\ref{appendix:code}. To get an overview of how much of an impact they have, the following subjects were investigated:
