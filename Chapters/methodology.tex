...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
        \textbf{Processor model} & Qualcomm MSM8994 Snapdragon 810\\
        \hline
...
All the tests were executed on Android version 7.1.1. Cellular was switched off and wifi was connected. No other background apps were present while performing the tests during the experiments.
