...
\begin{table}
    ...
    \input{Data/results/FFT/CPP_Princeton_converted_Iterative.tex}
\end{table}
\begin{table}
    \centering
    \label{tab:cpp:princeton:recursive}
    \caption{C++ Princeton Recursive, Time (ms)}
    \input{Data/results/FFT/CPP_Princeton_converted_Recursive.tex}
\end{table}
\begin{table}
    \centering
...
\begin{figure}
    \centering
    \input{Data/results/FFT/Java_Princeton_Recursive_barplot.tex}
