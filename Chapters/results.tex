...
Table~\ref{tab:result:gc:trigger} shows how many garbage collections that were triggered during the tests. Each row includes all block sizes and 100 iterations for one algorithm. The sticky concurrent mark sweep 

\begin{table}[H]
    \centering
    \caption{Pauses due to garbage collection, Time (ms)}
    \label{tab:result:gc:trigger}
    \resizebox{\columnwidth}{!}{
        \rowcolors{1}{}{lightgray}
        \begin{tabular}{|l|rr|rr|}\toprule
            \textbf{Block size} & \textbf{\# partial} & \textbf{total time} & \textbf{\# sticky} & \textbf{total time}\\\midrule
            \textbf{Java Columbia Iterative}        & 0 & 0 & 0 & 0\\
            \textbf{Java Princeton Iterative}       & 328 & 1868.38 & 325 & 1811.70\\
            \textbf{Java Princeton Recursive}       & 360 & 645.88 & 85 & 486.97\\
            \textbf{Java Float Columbia Iterative}  & 0 & 0 & 0 & 0\\
            \textbf{Java Float Princeton Iterative} & 410 & 3194.31 & 348 & 2965.09\\
            \textbf{Java Float Princeton Recursive} & 398 & 598.55 & 580 & 1137.00\\
