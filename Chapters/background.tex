...
The Fast Fourier Transform algorithm composed by Cooley and Tukey was a recursive algorithm that 
...
\begin{figure}
    ...
    \begin{tikzpicture}[node distance=2cm]
        ...
        \node [draw,circle,below right=-3mm and 2mm of A,inner sep=0pt] (plus) {$\times$};
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption{Butterfly update for 8 values}
